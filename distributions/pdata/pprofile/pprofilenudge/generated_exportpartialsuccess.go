...
type ExportPartialSuccess struct {
	orig  *nudgecollectorprofile.ExportProfilesPartialSuccess
	state *internal.State
}

func newExportPartialSuccess(orig *nudgecollectorprofile.ExportProfilesPartialSuccess, state *internal.State) ExportPartialSuccess {
...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(&nudgecollectorprofile.ExportProfilesPartialSuccess{}, &state)
}
...
func (ms ExportPartialSuccess) MoveTo(dest ExportPartialSuccess) {
	...
	*dest.orig = *ms.orig
	*ms.orig = nudgecollectorprofile.ExportProfilesPartialSuccess{}
}
