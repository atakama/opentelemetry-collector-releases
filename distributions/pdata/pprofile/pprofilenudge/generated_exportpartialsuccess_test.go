...
func TestExportPartialSuccess_MoveTo(t *testing.T) {
	...
	assert.Panics(t, func() {
		ms.MoveTo(newExportPartialSuccess(&nudgecollectorprofile.ExportProfilesPartialSuccess{}, &sharedState))
	})
	assert.Panics(t, func() {
		newExportPartialSuccess(&nudgecollectorprofile.ExportProfilesPartialSuccess{}, &sharedState).MoveTo(dest)
	})
}
...
func TestExportPartialSuccess_CopyTo(t *testing.T) {
	...
	sharedState := internal.StateReadOnly
	assert.Panics(t, func() {
		ms.CopyTo(newExportPartialSuccess(&nudgecollectorprofile.ExportProfilesPartialSuccess{}, &sharedState))
	})
}
...
func TestExportPartialSuccess_RejectedProfiles(t *testing.T) {
	...
	sharedState := internal.StateReadOnly
	assert.Panics(t, func() {
		newExportPartialSuccess(&nudgecollectorprofile.ExportProfilesPartialSuccess{}, &sharedState).SetRejectedProfiles(int64(13))
	})
}
...
func TestExportPartialSuccess_ErrorMessage(t *testing.T) {
	...
	sharedState := internal.StateReadOnly
	assert.Panics(t, func() {
		newExportPartialSuccess(&nudgecollectorprofile.ExportProfilesPartialSuccess{}, &sharedState).SetErrorMessage("error message")
	})
}
