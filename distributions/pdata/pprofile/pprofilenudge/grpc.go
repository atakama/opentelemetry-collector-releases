...
package pprofilenudge // import "go.opentelemetry.io/collector/pdata/pprofile/pprofilenudge"
...
import (
	...
	nudgecollectorprofile "go.opentelemetry.io/collector/pdata/internal/data/protogen/collector/profiles/v1development"
...
func NewGRPCClient(cc *grpc.ClientConn) GRPCClient {
	return &grpcClient{rawClient: nudgecollectorprofile.NewProfilesServiceClient(cc)}
}

type grpcClient struct {
	rawClient nudgecollectorprofile.ProfilesServiceClient
}
...
func RegisterGRPCServer(s *grpc.Server, srv GRPCServer) {
	nudgecollectorprofile.RegisterProfilesServiceServer(s, &rawProfilesServer{srv: srv})
}
...
func (s rawProfilesServer) Export(ctx context.Context, request *nudgecollectorprofile.ExportProfilesServiceRequest) (*nudgecollectorprofile.ExportProfilesServiceResponse, error) {
