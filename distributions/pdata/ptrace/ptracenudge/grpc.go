...
package ptracenudge // import "go.opentelemetry.io/collector/pdata/ptrace/ptracenudge"
...
import (
	...
	nudgecollectortrace "go.opentelemetry.io/collector/pdata/internal/data/protogen/collector/trace/v1"
...
func NewGRPCClient(cc *grpc.ClientConn) GRPCClient {
	return &grpcClient{rawClient: nudgecollectortrace.NewTraceServiceClient(cc)}
}

type grpcClient struct {
	rawClient nudgecollectortrace.TraceServiceClient
}
...
func RegisterGRPCServer(s *grpc.Server, srv GRPCServer) {
	nudgecollectortrace.RegisterTraceServiceServer(s, &rawTracesServer{srv: srv})
}
...
func (s rawTracesServer) Export(ctx context.Context, request *nudgecollectortrace.ExportTraceServiceRequest) (*nudgecollectortrace.ExportTraceServiceResponse, error) {
