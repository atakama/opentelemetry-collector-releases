...
type ExportPartialSuccess struct {
	orig  *nudgecollectortrace.ExportTracePartialSuccess
	state *internal.State
}

func newExportPartialSuccess(orig *nudgecollectortrace.ExportTracePartialSuccess, state *internal.State) ExportPartialSuccess {
...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(&nudgecollectortrace.ExportTracePartialSuccess{}, &state)
}
...
func (ms ExportPartialSuccess) MoveTo(dest ExportPartialSuccess) {
	...
	*dest.orig = *ms.orig
	*ms.orig = nudgecollectortrace.ExportTracePartialSuccess{}
}
