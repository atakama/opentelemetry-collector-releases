...
package pmetricnudge // import "go.opentelemetry.io/collector/pdata/pmetric/pmetricotlp"
...
func NewGRPCClient(cc *grpc.ClientConn) GRPCClient {
	return &grpcClient{rawClient: nudgecollectormetrics.NewMetricsServiceClient(cc)}
}

type grpcClient struct {
	rawClient nudgecollectormetrics.MetricsServiceClient
}
...
func RegisterGRPCServer(s *grpc.Server, srv GRPCServer) {
	nudgecollectormetrics.RegisterMetricsServiceServer(s, &rawMetricsServer{srv: srv})
}
...
func (s rawMetricsServer) Export(ctx context.Context, request *nudgecollectormetrics.ExportMetricsServiceRequest) (*nudgecollectormetrics.ExportMetricsServiceResponse, error) {
