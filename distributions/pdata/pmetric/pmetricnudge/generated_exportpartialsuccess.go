...
type ExportPartialSuccess struct {
	orig  *nudgecollectormetrics.ExportMetricsPartialSuccess
	state *internal.State
}

func newExportPartialSuccess(orig *nudgecollectormetrics.ExportMetricsPartialSuccess, state *internal.State) ExportPartialSuccess {
...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(&nudgecollectormetrics.ExportMetricsPartialSuccess{}, &state)
}
...
func (ms ExportPartialSuccess) MoveTo(dest ExportPartialSuccess) {
	...
	*dest.orig = *ms.orig
	*ms.orig = nudgecollectormetrics.ExportMetricsPartialSuccess{}
}
