...
package plognudge // import "go.opentelemetry.io/collector/pdata/plog/plognudge"
...
import (
	...
	nudgecollectorlog "go.opentelemetry.io/collector/pdata/internal/data/protogen/collector/logs/v1"
...
func NewGRPCClient(cc *grpc.ClientConn) GRPCClient {
	return &grpcClient{rawClient: nudgecollectorlog.NewLogsServiceClient(cc)}
}

type grpcClient struct {
	rawClient nudgecollectorlog.LogsServiceClient
}
...
func RegisterGRPCServer(s *grpc.Server, srv GRPCServer) {
	nudgecollectorlog.RegisterLogsServiceServer(s, &rawLogsServer{srv: srv})
}
...
func (s rawLogsServer) Export(ctx context.Context, request *nudgecollectorlog.ExportLogsServiceRequest) (*nudgecollectorlog.ExportLogsServiceResponse, error) {
