...
func TestExportPartialSuccess_MoveTo(t *testing.T) {
	...
	assert.Panics(t, func() { ms.MoveTo(newExportPartialSuccess(&nudgecollectorlog.ExportLogsPartialSuccess{}, &sharedState)) })
	assert.Panics(t, func() {
		newExportPartialSuccess(&nudgecollectorlog.ExportLogsPartialSuccess{}, &sharedState).MoveTo(dest)
	})
}
...
func TestExportPartialSuccess_CopyTo(t *testing.T) {
	...
	assert.Equal(t, orig, ms)
	sharedState := internal.StateReadOnly
	assert.Panics(t, func() { ms.CopyTo(newExportPartialSuccess(&nudgecollectorlog.ExportLogsPartialSuccess{}, &sharedState)) })
}
...
func TestExportPartialSuccess_RejectedLogRecords(t *testing.T) {
	...
	sharedState := internal.StateReadOnly
	assert.Panics(t, func() {
		newExportPartialSuccess(&nudgecollectorlog.ExportLogsPartialSuccess{}, &sharedState).SetRejectedLogRecords(int64(13))
	})
}
...
func TestExportPartialSuccess_ErrorMessage(t *testing.T) {
	...
	sharedState := internal.StateReadOnly
	assert.Panics(t, func() {
		newExportPartialSuccess(&nudgecollectorlog.ExportLogsPartialSuccess{}, &sharedState).SetErrorMessage("error message")
	})
}
