...
type ExportPartialSuccess struct {
	orig  *nudgecollectorlog.ExportLogsPartialSuccess
	state *internal.State
}

func newExportPartialSuccess(orig *nudgecollectorlog.ExportLogsPartialSuccess, state *internal.State) ExportPartialSuccess {
...
func NewExportPartialSuccess() ExportPartialSuccess {
	...
	return newExportPartialSuccess(&nudgecollectorlog.ExportLogsPartialSuccess{}, &state)
}
...
func (ms ExportPartialSuccess) MoveTo(dest ExportPartialSuccess) {
	...
	*dest.orig = *ms.orig
	*ms.orig = nudgecollectorlog.ExportLogsPartialSuccess{}
}
