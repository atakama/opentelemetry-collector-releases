...
func nudgeHTTPClientConfig(endpoint string, headers map[string]configopaque.String, tlsSetting configtls.ClientConfig, compression configcompression.Type) NudgeHTTPClientConfig { //confighttp.ClientConfig{
	return NudgeHTTPClientConfig{
		ClientConfig: clientConfig(endpoint, headers, tlsSetting, compression),
	}
}
...
func TestCreateTraces(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "NoEndpoint",
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig("", nil, configtls.ClientConfig{}, configCompression), //   ClientConfig: clientConfig("", nil, configtls.ClientConfig{}, configCompression),
			},
		...
		},
		{
			name: "UseSecure",
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, nil, configtls.ClientConfig{
					Insecure: false,
				}, configCompression),
		...
		},
		{
			name: "Headers",
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, map[string]configopaque.String{
					"hdr1": "val1",
					"hdr2": "val2",
		...
		},
		{
			...
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, nil, configtls.ClientConfig{}, "none"),
		...
		},
		{
			...
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, nil, configtls.ClientConfig{}, configcompression.TypeGzip),
		...
		},
		{
			...
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, nil, configtls.ClientConfig{}, configcompression.TypeSnappy),
		...
		},
		{
			...
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, nil, configtls.ClientConfig{}, configcompression.TypeZstd),
		...
		},
		{
			name: "ProtoEncoding",
			config: &Config{
				NudgeHTTPClientConfig: nudgeHTTPClientConfig(endpoint, nil, configtls.ClientConfig{}, configCompression),
