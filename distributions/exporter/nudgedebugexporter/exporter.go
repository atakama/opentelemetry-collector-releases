...
package nudgedebugexporter // import "go.opentelemetry.io/collector/exporter/nudgedebugexporter"
...
import (
	...
	"go.opentelemetry.io/collector/exporter/nudgedebugexporter/internal/normal"
	"go.opentelemetry.io/collector/exporter/nudgedebugexporter/internal/nudgetext"
...
func newDebugExporter(logger *zap.Logger, verbosity configtelemetry.Level) *debugExporter {
	...
	if verbosity == configtelemetry.LevelDetailed {
		logsMarshaler = nudgetext.NewTextLogsMarshaler()
		metricsMarshaler = nudgetext.NewTextMetricsMarshaler()
		tracesMarshaler = nudgetext.NewTextTracesMarshaler()
		profilesMarshaler = nudgetext.NewTextProfilesMarshaler()
	} else {
