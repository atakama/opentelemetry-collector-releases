...
import (
	...
	"go.opentelemetry.io/collector/exporter/nudgedebugexporter/internal/metadata"
	"go.opentelemetry.io/collector/exporter/nudgedebugexporter/internal/nudgetext"
	"go.opentelemetry.io/collector/exporter/xexporter"
)

// The value of "type" key in configuration.
var componentType = component.MustNewType("nudgedebug")
...
func createTraces(ctx context.Context, set exporter.Settings, config component.Config) (exporter.Traces, error) {
	...
	return exporterhelper.NewTraces(ctx, set, config,
		...
		exporterhelper.WithShutdown(nudgetext.LoggerSync(exporterLogger)),
	)
}
